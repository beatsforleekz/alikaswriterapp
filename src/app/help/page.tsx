...
export default function HelpPage() {
  return (
    <div>
      ...
      <SectionCard title="How to conduct an Archive Review"><ul style={{ paddingLeft: "1.2rem" }}><li>Work by date/year and open each session workspace.</li><li>Add known songs, writers, and assets/evidence links.</li><li>Add follow-up actions for anything missing.</li><li>Set Evidence Strength based on the quality of proof currently available.</li><li>Mark Archive Reviewed only once you have checked what is reasonably available.</li></ul><p className="helper" style={{ marginTop: ".6rem" }}>Reviewed does not mean complete. It means the session has been checked at least once.</p></SectionCard>
